...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse> createOrderWithDetails(@Valid @RequestBody CreateOrderRequestDTO createOrderRequestDTO) {
        try {
            ...
            orderService.createOrderAndDetails(createOrderRequestDTO);
