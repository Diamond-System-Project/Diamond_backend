...
public class PromotionServiceImpl implements PromotionService {
    ...
    public Promotion createPromotion(PromotionDTO promotionDTO) {
        if (promotionRepository.existsPromotionName(promotionDTO.getPromotionName())) {
    ...
    public Promotion updatePromotion(PromotionDTO promotionDTO, int id) {
        ...
        if (!savePromotion.getPromotionName().equals(promotionDTO.getPromotionName()) && promotionRepository.existsPromotionName(promotionDTO.getPromotionName())) {
            throw new IllegalArgumentException("Promotion name already exists");
        }
